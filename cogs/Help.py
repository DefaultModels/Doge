...
class Help(commands.Cog):
    ...
    async def help(self, ctx, category=None):
      if category == None:
        ...
        em.add_field(name = "Other",value = "```ping, premium```", inline=False)
      ...
      if category == "profile":
        em = discord.Embed(title = "Profile command",color = discord.Color.from_rgb(47, 49, 54),description = "See another players profile or if you don't mention than your own profile. ```+profile MENTION```")
        em.add_field(name=":link: Quick Links",value="[Vote For Me](https://top.gg/bot/785160383560286240/vote) - [Invite Me](https://discord.com/oauth2/authorize?client_id=785160383560286240&scope=bot&permissions=2147483647) - [Support Server](https://discord.gg/3d6BpRHvbR) - [Premium/Donate](https://donatebot.io/checkout/794412631543906365)", inline=False)
        await ctx.send(embed = em)
        return

      if category == "inventory":
        em = discord.Embed(title = "Inventory command",color = discord.Color.from_rgb(47, 49, 54),description = "See another players inventory or if you don't mention than your own inventory. ```+inventory MENTION```")
        em.add_field(name=":link: Quick Links",value="[Vote For Me](https://top.gg/bot/785160383560286240/vote) - [Invite Me](https://discord.com/oauth2/authorize?client_id=785160383560286240&scope=bot&permissions=2147483647) - [Support Server](https://discord.gg/3d6BpRHvbR) - [Premium/Donate](https://donatebot.io/checkout/794412631543906365)", inline=False)
        await ctx.send(embed = em)
        return

      if category == "stock":
        em = discord.Embed(title = "Stock command",color = discord.Color.from_rgb(47, 49, 54),description = "Get more info on an in-game stock. ```+stock STOCK_ID```")
        em.add_field(name=":link: Quick Links",value="[Vote For Me](https://top.gg/bot/785160383560286240/vote) - [Invite Me](https://discord.com/oauth2/authorize?client_id=785160383560286240&scope=bot&permissions=2147483647) - [Support Server](https://discord.gg/3d6BpRHvbR) - [Premium/Donate](https://donatebot.io/checkout/794412631543906365)", inline=False)
        await ctx.send(embed = em)
        return
