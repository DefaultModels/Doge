...
class Help(commands.Cog):
    ...
    async def help(self, ctx, category=None):
      if category == None:
        ...
        em.add_field(name = "Currency",value = "```cook, beg, farm, balance,  work, postmemes, search, slots, multiplier, prestige, deposit, withdraw, shop, buy, rob, pay, stock, weekly, daily, gig``", inline=False)
